...
namespace TDSProtocolTests
{
	...
	public class TDSPreLoginMessageTests
	{
		...
		public void TestInterpretPayloadEmptyTrace()
		{
			...
			actual.Payload = new byte[]
			                 {
				                 0x00, 0x00, 0x1F, 0x00, 0x06, 0x01, 0x00, 0x25, 0x00, 0x01, 0x02, 0x00, 0x26, 0x00, 0x01, 0x03,
				                 0x00, 0x27, 0x00, 0x04, 0x04, 0x00, 0x2B, 0x00, 0x01, 0x05, 0x00, 0x2C, 0x00, 0x00, 0xFF, 0x09,
				                 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0xB8, 0x0D, 0x00, 0x00, 0x01
			                 };
			actual.InterpretPayload();
